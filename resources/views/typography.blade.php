        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                @section ('typo5_panel_body')
                    ...
                    <blockquote class="pull-right"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                @section ('typo8_panel_body')
                    <p>This is an example of an inline code element within body copy. Wrap inline code within a <code>
